...
const login =async(req,res)=>{
    ...
    if(!isPASSok){
        ...
        return res.status(200).cookie('accessToken',accessToken,{secure:true,httpOnly:true,sameSite: "None"})
...
.clearCookie('accessToken',{secure:true,httpOnly:true,sameSite: "None"}).json({message:"Logout success",user})
}
